...
class_data = {
    "Gunner": {"health": 200, "damage": 20, "speed": 3, "cooldown": 15, "player_size": 0.25,
               ...
               "xoffset": 45, "yoffset": 20, "stun": 0, "up_1": "Bullet speed", "up_2": "Fire rate", "up_3": "Knockback",
    ...
    "Sniper": {"health": 100, "damage": 80, "speed": 4, "cooldown": 80, "player_size": 0.25,
               ...
               "grenade": pygame.image.load('Graphics/grenade.png'), "exp": pygame.image.load('Graphics/explode.png')},
    "Crossbow": {"health": 150, "damage": 80, "speed": 3, "cooldown": 50, "player_size": 0.25,
                 ...
                 "up_4": "Fire rate", "evo_1": "Triple Shot", "evo_2": "Big Bolt", "desc_1": "Fire three arrows",
...
shape_data = {
    ...
    3: {"health": 30, "attack_damage": 25, "speed": 2, "colour": (255, 255, 0), "radius": 30},
